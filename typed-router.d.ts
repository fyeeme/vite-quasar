...
declare module '@vue-router/routes' {
  export interface RouteNamedMap {
    ...
    '//': RouteRecordInfo<'//', '/', Record<never, never>, Record<never, never>>,
    '//annimation/drawer': RouteRecordInfo<'//annimation/drawer', '/annimation/drawer', Record<never, never>, Record<never, never>>,
    '//annimation/keyframework': RouteRecordInfo<'//annimation/keyframework', '/annimation/keyframework', Record<never, never>, Record<never, never>>,
    '//blank': RouteRecordInfo<'//blank', '/blank', Record<never, never>, Record<never, never>>,
    '//demonstrate/windicss': RouteRecordInfo<'//demonstrate/windicss', '/demonstrate/windicss', Record<never, never>, Record<never, never>>,
